...
exports.getUsuarioByName = (req, res) => {
    const usuarioName = req.params.nombre;
    Usuario.findAll({ where: { nombre: usuarioName } })
        .then(usuarios => {
            res.status(200).json({
                message: "Usuarios obtenidos exitosamente con el nombre = " + usuarioName,
                usuarios: usuarios
            });
        })
        .catch(error => {
