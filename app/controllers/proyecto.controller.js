...
exports.create = (req, res) => {
    ...
    try {
        proyecto.id_proyecto = req.body.id_proyecto;
...
exports.getProyectoByName = (req, res) => {
    const proyectoName = req.params.nombre;
    Proyecto.findAll({ where: { nombre: proyectoName } })
        .then(proyectos => {
            res.status(200).json({
                message: "Proyectos obtenidos exitosamente con el nombre = " + proyectoName,
                proyectos: proyectos
            });
        })
        .catch(error => {
