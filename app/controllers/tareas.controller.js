...
exports.getTareaByName = (req, res) => {
    const tareaName = req.params.nombre;
    Tarea.findAll({ where: { nombre: tareaName } })
        .then(tareas => {
            res.status(200).json({
                message: "Tareas obtenidas exitosamente con el nombre = " + tareaName,
                tareas: tareas
            });
        })
        .catch(error => {
